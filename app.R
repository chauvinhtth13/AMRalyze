...
ui <- page_navbar(
  ...
  nav_panel(
    ...
    # Pathogen Summary Section with responsive height
    div(class = "mb-4",
        card(
          class = "shadow-sm",
          card_header(
            div(class = "d-flex justify-content-between align-items-center",
                h4("Pathogen Distribution", class = "mb-0 text-dark fw-bold"),
                span(class = "badge bg-light text-dark", "Interactive Chart")
            ),
            class = "bg-light border-0"
          ),
          card_body(
            # Dynamic height based on screen size
            plotlyOutput("pathogen_summary_plot", 
                         width = "100%", 
                         height = "450px"),
            class = "p-3"
          ),
    ...
    # Resistance Patterns Section with improved responsive design
    card(
      class = "shadow-sm",
      card_header(
        h4("Antimicrobial Resistance Patterns", class = "mb-0 text-dark fw-bold"),
        class = "bg-light border-0"
      ),
      navset_card_tab(
        id = "ast_card_tabs",
        
        # Gram-Negative Tab with improved responsive sidebar
        nav_panel(
          title = "Gram-Negative",
          layout_sidebar(
            sidebar = sidebar(
              ...
              div(class = "mb-3",
                  ...
                  p("Select pathogens to analyze resistance patterns", 
              ...
              div(class = "bg-white rounded p-3 border",
                  h6("Quick Stats", class = "text-secondary fw-bold mb-2"),
                ...
                card(
                  ...
                  card_header(
                    div(class = "d-flex justify-content-between align-items-center",
                        ...
                        downloadButton("download_gram_neg", "Export Results", 
        ...
        # Gram-Positive Tab with consistent styling
        nav_panel(
          title = "Gram-Positive",
          layout_sidebar(
            sidebar = sidebar(
            ...
            div(class = "flex-fill",
                card(
                  ...
                  card_header(
                    div(class = "d-flex justify-content-between align-items-center",
                        h5("Resistance Summary Table", class = "mb-0"),
                        downloadButton("download_gram_pos", "Export Results",
                                       class = "btn btn-outline-primary btn-sm")
                    )
                  ),
                  card_body(
        ...
        # Fungal Tab with consistent styling
        nav_panel(
          title = "Fungal",
          layout_sidebar(
            sidebar = sidebar(
                ...
                card(
                  ...
                  card_header(
                    div(class = "d-flex justify-content-between align-items-center",
                        ...
                        downloadButton("download_fungal", "Export Results",
                                       class = "btn btn-outline-primary btn-sm") 
                    )
                  ),
                  card_body(
